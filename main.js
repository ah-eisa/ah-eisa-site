...
const HEADER_HTML = `
  ...
  <div class="mobile-menu" id="mobileMenu">
    ...
    <a href="projects.html">Selected Work</a><a href="certifications.html">Credentials</a><a href="blog.html">Insights</a>
...
(function initShell(){
  ...
  document.querySelectorAll('.nav a,.mobile-menu a').forEach(a=>{if(a.getAttribute('href')===page)a.classList.add('active')});
